...
class OutlineSlide(BaseModel):
    ...
    key_messages: list[str] = Field(
        ...
        description="The ABSOLUTE source of truth for this slide's content. Every "
                    ...
                    "\n"
                    "Each key_message carries SEMANTIC intent — it describes the SHAPE "
                    "of the information, not the component that will render it. The "
                    "downstream slide component planner reads the shape to decide "
                    "which component type and composition fits:\n"
                    "  • A standalone metric → quantitative emphasis: "
                    "'ARR reached $42.8M (+18% QoQ)'\n"
                    "  • A time-series or comparison → temporal/comparative data: "
                    "'Revenue by quarter: Q1 $28.4M, Q2 $31.2M, Q3 $36.1M, Q4 $42.8M'\n"
                    "  • A multi-column record set → structured multi-attribute data: "
                    "'Enterprise $28.1M +22% | Mid-Market $10.4M +14% | SMB $4.3M +8%'\n"
                    "  • A qualitative insight → explanatory prose: 'Self-serve "
