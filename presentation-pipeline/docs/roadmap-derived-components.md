...
**Status: built 2026-09-24 (branch `phase-5-table-sizing`); eval `phase-5-tables` imported, fixes (e)/(b')/compile fallback built after it — awaiting re-eval** (`eval_run gj-h1-regen --repeat 1 --label phase-5-tables-2`).
